...
<body>
	...
	<section id="container" class="">
		...
		<header class="header white-bg">
			...
			<a href="index.html" class="logo">物料<span> 管理系统</span></a>
			<!-- START HEADER  NAV -->
			...
			<div id="sidebar" class="nav-collapse">
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="sub-menu"><a href="javascript:;" class="active">
						...
						<ul class="sub">
							<li class="active"><a href="productAdd.jsp"> 录入 </a></li>
					...
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading">
								<span class="label label-primary">物料入库</span>
							</header>
							<div class="panel-body">
								<div class=" form">
									<form class="cmxform form-horizontal tasi-form"
										id="commentForm" method="get" action="form_validation.html"
										novalidate="novalidate">
										<div class="form-group ">
											<label for="cname" class="control-label col-lg-2">产品名称
												(必填)</label>
											<div class="col-lg-10">
												<input class=" form-control" id="cname" name="product.name"
													type="text" required="">
											</div>
										</div>
										<div class="form-group ">
											<label for="cname" class="control-label col-lg-2">产品类型
												(必填)</label>
											<div class="col-lg-10">
												<input class=" form-control" id="cname" name="product.name"
													type="text" required="">
										...
										<div class="form-group ">
											<label for="cname" class="control-label col-lg-2">产品大小
												(必填)</label>
											<div class="col-lg-10">
												<input class=" form-control" id="cname" name="product.name"
													type="text" required="">
										...
										<div class="form-group ">
											<label for="ccomment" class="control-label col-lg-2">入库时间</label>
